...
export async function refreshNativeAccountCatalog({
  ...
  // network request. Only explicit native consent opens Codex account data
  // while all other credential discovery remains disabled.
  const allowed = () => nativeSessionAccessAllowed({ discoveryOff, sharingEnabled });

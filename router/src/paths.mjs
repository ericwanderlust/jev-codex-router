...
// Permission to compare an incoming Codex bearer only; never session sharing.
export const NATIVE_CALLER_AUTH_CONSENT_PATH = path.join(STATE_DIR, "native-caller-auth-consent.json");

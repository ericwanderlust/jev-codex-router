...
test("disabling discovery empties providers and blocks Codex session sharing without consent", async () => {
  ...
  try {
    ...
    // Without the separate sharing-consent marker, auth.json remains private.

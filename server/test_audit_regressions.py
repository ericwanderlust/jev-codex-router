...
class CacheRegression(unittest.TestCase):
    def test_rotated_log_is_included_in_the_report_window(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            line = json.dumps({
                ...
                "model": report_routing.LEGACY_TERRA,
            }) + "\n"
    ...
    def test_terra_swaps_and_cache_counters_do_not_depend_on_credit_prices(self):
        ...
        }]} for model in (report_routing.LEGACY_SOL,
                         report_routing.LEGACY_TERRA,
                         report_routing.LEGACY_SOL)]
        ...
        self.assertIn(report_routing.LEGACY_TERRA, result["by_model"])
